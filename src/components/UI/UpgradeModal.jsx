...
const FEATURE_COPY = {
  ...
  charts: {
    title: '組織図をもっと作るには',
    body: '作成できる組織図は、無料1つ・ライト5つ・プロ無制限です。上位プランで増やせます。',
  },
  share: {
    title: '共有リンクを使うには',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 18 }}>
          <PlanRow name={PLANS.free.name}  price="¥0"    note="組織図1つ・100人・写真OK・共有可" current={plan === 'free'} />
          <PlanRow name={PLANS.light.name} price="¥380"  note="組織図5つ・500人まで・共有・印刷/PDF" current={plan === 'light'} highlight />
